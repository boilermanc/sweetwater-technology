    ...
    <>
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <span className="text-2xl tracking-tighter text-slate-900">
            <span className="font-extrabold">SWEETWATER</span>
            <span style={{ fontFamily: "'Satisfy', cursive" }} className="ml-1 text-3xl font-semibold"><span className="text-blue-600">T</span>echnology</span>
          </span>
        </div>
